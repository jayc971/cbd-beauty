...
<main class="main-content">
                ...
                <div class="carousel-track">
                    ...
                    ?>
                        <a href="<?php the_permalink(); ?>" class="product-card-link">
                            <div class="product-card" tabindex="0" role="button" aria-label="<?php the_title(); ?>">
                                <div class="product-image">
                                    <?php if (has_post_thumbnail()) : ?>
                                        <img src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>" 
                                             ...
                                             height="300">
                                    <?php else : ?>
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/placeholder-product.jpg" 
                                             alt="<?php the_title(); ?>" 
                                             loading="lazy"
                                             width="300"
                                             height="300">
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-actions">
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="quick-view-btn">View Details</a>
                                </div>
                            </div>
                        </div>
                    <?php
            ...
            <div class="modal-body">
                ...
                <div class="modal-info">
                    ...
                    <div class="modal-actions">
                        <a href="#" id="modal-product-link" class="quick-view-btn">View Details</a>
                    </div>
                </div>
            </div>
            <div class="modal-navigation">
                <button class="modal-prev" aria-label="Previous product">←</button>
                <button class="modal-next" aria-label="Next product">→</button>
            </div>
        </div>
    </div>
    ...
    <section class="cart-section">
        <div class="container">
            <?php echo do_shortcode('[cbd_beauty_cart]'); ?>
        </div>
    </section>
